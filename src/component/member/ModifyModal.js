                ...
                <div className="flex flex-col justify-center h-full p-3">
                    <div className="text-center w-full h-3/4 mb-2 flex flex-col justify-center items-center">
                        <div className="flex justify-center flex-col">
                            <img onClick={onUploadImageButtonClick} className="rounded-full m-auto w-40 h-40" alt="profile" src={profileImage ? profileImage : (imageName ? `http://localhost:4040/api/user/${imageName}`: "https://i.pinimg.com/564x/d9/7b/bb/d97bbb08017ac2309307f0822e63d082.jpg")}/>
                    ...
                    <div className="text-center flex gap-3 justify-center">
                        <button className="border py-2 px-5 rounded-md bg-blue-400" >수정</button>

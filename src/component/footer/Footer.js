    ...
    return(
        <footer className="w-full bg-slate-100">
            ...
            <div className="w-4/5 mx-auto text-gray-800 flex flex-wrap flex-col py-2">
                    ...
                    <span className="text-xs text-gray-400 font-medium my-1">github : <Link to="https://github.com/conchohi/modak_front">https://github.com/conchohi/modak_front</Link></span> 
            </div>
